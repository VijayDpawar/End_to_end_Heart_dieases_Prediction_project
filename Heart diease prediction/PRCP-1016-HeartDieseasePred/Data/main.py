...
path = '/home/tecblic/Documents/Heart diease prediction/PRCP-1016-HeartDieseasePred/Data/Logistic_regression_model.pkl'

model = pickle.load(open(path,"rb")) # open model in read mode
